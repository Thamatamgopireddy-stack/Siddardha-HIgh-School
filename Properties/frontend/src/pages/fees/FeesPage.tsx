...
import { Plus, CreditCard, Receipt, FileDown, Download, AlertCircle, Upload } from 'lucide-react'
...
import {
  ...
  useBulkImportFeeCollectionsExcel,
} from '@/api/hooks'
...
export function FeesPage() {
  ...
  const bulkImportFeeCollectionsMutation = useBulkImportFeeCollectionsExcel()
  ...
  return (
    <PageWrapper
      ...
      actions={
        <div className="flex gap-2">
          ...
          >
            <Upload className="h-4 w-4" /> Import Fee Excel
          </button>
          <button
    ...
    >
      <ExcelImportModal
        ...
        title="Fee Collections Excel Import"
        description="Upload an Excel sheet (.xlsx, .xls) or CSV file containing offline student fee payment collection records."
        templateUrl="/fees/collections/bulk-template"
        templateFileName="fee_collections_import_template.xlsx"
        onImport={async (file) => await bulkImportFeeCollectionsMutation.mutateAsync(file)}
      />
